...
public class RessonatorRecipeCategory implements IRecipeCategory<RessonatorRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(prelude.MODID, "ressonate");
    ...
    public RessonatorRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public Class<? extends RessonatorRecipe> getRecipeClass() {
        return RessonatorRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TextComponent("ressonator");
    }
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull RessonatorRecipe recipe, @Nonnull IFocusGroup focusGroup) {
