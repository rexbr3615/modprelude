...
public class SmartAmphibiousMoveControl extends MoveControl {
    ...
    public SmartAmphibiousMoveControl(DinossauroComplex entityIn, int maxTurnX, int maxTurnY, float waterSpeedFactor, float landSpeedFactor, boolean applyGravity) {
        super(entityIn);
        this.mob = entityIn;
