...
public class RessonatorScreen extends AbstractContainerScreen<RessonatorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(prelude.MODID, "textures/gui/ressonator.png");

    public RessonatorScreen(RessonatorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
