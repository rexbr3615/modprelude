...
public class CleanerMenu extends AbstractContainerMenu {
    private final CleanerEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public CleanerMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public CleanerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.CLEANER_MENU.get(), pContainerId);
        checkContainerSize(inv, 4);
        blockEntity = ((CleanerEntity) entity); //aa11111111111111
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.CLEANER.get()); //aa
    }
