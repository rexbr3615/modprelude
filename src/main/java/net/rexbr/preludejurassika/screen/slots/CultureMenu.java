...
public class CultureMenu extends AbstractContainerMenu {
    ...
    public CultureMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public CultureMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.CULTURE_MENU.get(), pContainerId);
        checkContainerSize(inv, 4);
        blockEntity = ((CultureEntity) entity); //aa
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.CULTURE_VAT.get()); //aa
    }
