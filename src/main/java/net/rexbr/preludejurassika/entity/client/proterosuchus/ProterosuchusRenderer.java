package net.rexbr.preludejurassika.entity.client.proterosuchus;
...
import net.rexbr.preludejurassika.entity.client.prolibytherium.ProlibytheriumModel;
import net.rexbr.preludejurassika.entity.custom.ProlibytheriumEntity;
import net.rexbr.preludejurassika.entity.custom.ProterosuchusEntity;
