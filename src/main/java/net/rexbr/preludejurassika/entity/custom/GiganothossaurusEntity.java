...
public class GiganothossaurusEntity extends Animal implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public GiganothossaurusEntity(EntityType<? extends Animal> entityType, Level level) {
