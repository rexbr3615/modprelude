...
public class PreTest extends PreludeEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);
    private boolean isSwimming;

    public void PreludeEntity(String[] args) {
        this.GeoLocation = "prelude/geo/achilobator.geo.json";
        this.texLocation = "prelude/textures/dinossaur/achilobator1.png";
        this.AnimLocation = "prelude/animations/achilobator.animation.json";
    }

    public PreTest(EntityType<? extends Animal> entityType, Level level) {
